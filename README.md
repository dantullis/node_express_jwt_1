...
## USE APP:
	Step 1: In web browser navigate to: http://localhost:3000 
		Should receive: Hello! This is a base non-secure non-API route
	Step 2: In web browser navigate to: http://localhost:3000/usersetup 
		Should receive: {"success":true}
	Step 3: Now use PostMan to authenticate by doing the following:
	...
	Step 4: Copy the token for use in Step 5 below.

	Step 5: in web browser navigate to:
